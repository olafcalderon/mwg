					...
					<tr>
						...
						<td>
							...
							if ( strtolower($zlib_output_compression) == 'on' ) {
								echo rey__wp_kses( sprintf( '<code class="ssFlag ssFlag--danger">%s</code> %s',
									__( 'On', 'rey' ),
									__( 'zlib.output_compression is problematic and throws errors most of the time in WordPress. Make sure to <a href="https://support.reytheme.com/kb/undefined-error-when-trying-to-install-plugins-or-import-demos/" target="_blank">disable it</a>.', 'rey' ) )
								);
							} else {
