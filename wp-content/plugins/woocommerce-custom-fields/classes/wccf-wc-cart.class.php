        ...
        foreach ($cart_items as $cart_item_key => $cart_item) {
            ...
            foreach ($price_changes[$cart_item_key]['alternatives'] as $base_price_candidate_key => $alternative_changes) {
                ...
                foreach ($alternative_changes['prices']['ranges'] as $price_range_index => $price_range) {
                    ...
                    // Adjust price
                    $adjusted_price = WCCF_Pricing::get_adjusted_price($base_price_candidate, $cart_item['product_id'], $variation_id, $cart_item_data, $cart_item['quantity'], false, false, $cart_item['data'], true);
