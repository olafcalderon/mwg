...
class SizeChart_User_Feedback
{
    ...
    public function display_admin_notice()
    {
        ...
        if ( isset( $screen->base ) && ('plugins' === $screen->base || 'edit-size-chart' === $screen->id) ) {
            ...
            printf( '<a href="%1$s" class="button button-primary editorsSizeChart-install-button" target="_blank">%2$s</a>', esc_url( $review_url ), esc_html__( 'Leave a Review', 'woocommerce-conditional-product-fees-for-checkout' ) );
            ?>
						<a href="<?php 
...
new SizeChart_User_Feedback( array(
    ...
    'name'       => __( 'Advanced Product Size Charts for WooCommerce', 'woocommerce-conditional-product-fees-for-checkout' ),
