		...
		function gs_settings( $page )
		{
			if(
				...
				$page->add_control(
					'gs_panel_heading',
					[
					   'label' => esc_html__( 'PREVIEW SETTINGS', 'rey-core' ),
				...
				$page->add_control(
					...
					[
						...
						'selectors' => [
							'.elementor-editor-active, .elementor-editor-preview' => '--panel-background-color: {{VALUE}};',
						],
						'condition' => [
							'gs_type' =>['offcanvas'],
						],
				...
				$page->add_control(
					...
					[
						'type' => \Elementor\Controls_Manager::RAW_HTML,
						'raw' => esc_html__('Please remember, these settings apply for this preview only!', 'rey-core'),
						'content_classes' => 'elementor-descriptor',
						'condition' => [
							'gs_type' =>['offcanvas'],
						],
